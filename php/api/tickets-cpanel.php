...
try {
    ...
    error_log("cPanel API - User authenticated: " . print_r($authData, true));
    
    // Set request data globally
    $_REQUEST_DATA = getRequestData();
    error_log("cPanel API - Request data: " . print_r($_REQUEST_DATA, true));
    error_log("cPanel API - Request method: " . $_SERVER["REQUEST_METHOD"]);
    error_log("cPanel API - Request URI: " . $_SERVER["REQUEST_URI"]);
